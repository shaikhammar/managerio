...
import type { AccountOption, BreadcrumbItem, RecurringJournalEntry } from '@/types';
...
export default function RecurringJournalEntryEdit({ entry, accounts, frequencies }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/accounting/recurring-journal-entries/${entry.id}/edit` },
    ];
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        day_of_month: entry.day_of_month.toString(),
        template_lines: entry.template_lines.map((l) => ({
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        put(`/accounting/recurring-journal-entries/${entry.id}`);
    }
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-5xl mx-auto p-4 md:p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader><CardTitle>Edit Recurring Journal Entry</CardTitle></CardHeader>
                    ...
                    <div className="flex justify-end gap-3">
                        <Button variant="outline" type="button" asChild>
                            <Link href={`/accounting/recurring-journal-entries/${entry.id}`}>Cancel</Link>
                        </Button>
