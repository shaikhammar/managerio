...
export default function AgedReceivables({ report, filters }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Aged Receivables Report" />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Unpaid sales invoices grouped by age</p>
                        </div>
                    </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b bg-muted/50">
                                <th className="text-left py-3 px-4 text-sm font-medium text-muted-foreground">Customer / Invoice</th>
                                            ...
                                            {bucket.items.map((item) => (
                                                <tr key={item.invoice_id} className="border-b last:border-0 hover:bg-muted/30 transition-colors">
                                                    <td className="py-3 px-4 text-sm">
                                                        ...
                                                        <Link 
                                                            href={`/sales/invoices/${item.invoice_id}`}
                        ...
                        <tfoot>
                            <tr className="bg-muted/30 font-bold border-t-2">
                                ...
                                <td className="py-3 px-4 text-right text-sm">{formatCurrency(grandTotal)}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
