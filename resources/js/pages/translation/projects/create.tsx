...
export default function ProjectCreate({ customers, suppliers, languages, languagePairs, serviceTypes, roles }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-4xl p-4 md:p-6">
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground text-sm">Create a new translation project</p>
                </div>
                        ...
                        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="md:col-span-2">
                                ...
                                <Input
                                    ...
                                    placeholder="e.g. Annual Report Translation Q1 2026"
                                />
                    ...
                    <Card>
                        ...
                        <CardContent className="flex flex-col gap-4">
                            {data.targets.length === 0 && (
                                <p className="text-muted-foreground py-4 text-center text-sm">No target languages added yet. Click "Add Target" to begin.</p>
                            )}
                                    ...
                                    {target.assignments.map((assignment, ai) => (
                                        <div key={ai} className="mt-2 grid grid-cols-1 gap-2 md:grid-cols-4">
                                            <div className="md:col-span-2">
                                                ...
                                                <InputError
                                                    message={(errors as Record<string, string>)[`targets.${ti}.assignments.${ai}.contact_id`]}
                                                />
                                            </div>
                                            <div>
                                                <Select
